        ...
        <main class="admin-main">
            ...
            <header class="admin-header">
                ...
                <div style="display: flex; align-items: center; gap: 16px;">
                    <span style="font-weight: 600; font-size: 0.9rem; color: var(--charcoal-light);"><i class="fa-solid fa-user-shield me-1" style="color: var(--maroon);"></i> {{ auth()->user()->name }} (Admin)</span>
                    <form action="{{ route('logout') }}" method="POST" style="margin: 0;">
                        @csrf
                        <button type="submit" class="btn btn-outline btn-sm"><i class="fa-solid fa-right-from-bracket me-1"></i> Sign Out</button>
                    </form>
                </div>
            </header>
